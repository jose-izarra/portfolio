...
export default function TechStack() {
    ...
    return (
        <section className="flex flex-col items-center min-h-[40vh] gap-y-6 mt-12">
            ...
            <div className="w-full sm:w-[90%] lg:w-9/12 flex flex-col items-center lg:flex-row justify-evenly gap-x-4 gap-y-6 relative">
                <div className="lg:h-full lg:w-1/3 flex items-center justify-center flex-col h-full">
                    <h2 className="mb-2">*According to <a className="hover:" href="https://github.com/jose-izarra">GitHub</a></h2>
                    <img
