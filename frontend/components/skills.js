        ...
        <> 
            <div className="flex flex-col w-full mb-[3.5em]">
                <div className="flex mx-auto">
                        <h3 className="text-[3rem] text-subtitle-color mb-[2rem]">Fluent in</h3>
                </div>
    ...
    (
        <>
            <div className="flex flex-col w-full">
                <div className="flex mx-auto ">
                        <h3 className="text-[3rem] text-subtitle-color mb-[3rem]">Frameworks and Languages I've worked with</h3>
                    </div>
