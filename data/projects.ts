...
export const projects: Project[] = [
  ...
  {
    title: "Factos API",
    description: "Fake news detection API using ensemble learning",
    purpose: "Gain experience with NLP pipelines",
    techStack: ["FastAPI", "NLTK", "TensorFlow", "Transformers"],
    status: {
      finished: true,
      message: "2025",
    },
    duration: "3 months",
    contributors: "4 people",
    project_url: "https://github.com/ramcav/factos_api",
    image_url: "/images/factos-api.webp",
  },
  {
    title: "Planwise",
    description: "Recommendation system for creating short, targeted plans around Madrid",
    purpose: "Learn about recommendation systems by building a usable product",
    techStack: ["FastAPI", "TensorFlow", "Recommenders", "PostgreSQL"],
    status: {
      finished: true,
      message: "2025",
    },
    ...
    project_url: "https://github.com/planwise-org/recommendation-system",
    image_url: "/images/planwise.gif",
  },
  {
    title: "Liesl",
